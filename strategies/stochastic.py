...
class StochasticIndicator(Strategy):
    def __init__(self, symbol, fast_window=12, slow_window=26, signal_window=9, htf_window=50,
                 ...
                 vol_fast_window=7, vol_slow_window=12,
    ...
    # high spread below ema pushing above does not influence?
    # high spread above ema pushing below does not influence?
    def enter_trade(self, ema, stoch_k, stoch_d, rsi, hist, vol):
        ...
        # spread_ma = self.compute_spread(stability_window=5)
        # spread = self.high - self.low # and spread < spread_ma * 2
